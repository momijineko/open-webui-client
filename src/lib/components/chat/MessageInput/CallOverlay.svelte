<script lang="ts">
	import { config, models, settings, showCallOverlay, TTSWorker, runtimeApiBaseUrl } from '$lib/stores';
			...
			>
				...
				{:else}
					<div
						...
						style={`background-image: url('${$runtimeApiBaseUrl}/models/model/profile/image?id=${model?.id}&lang=${$i18n.language}&voice=true');`}
					/>
				{/if}
				<!-- navbar -->
			</button>
